...
I recommend that you review how the SfIA framework operates - particularly the concept of "levels of responsibility" before starting to work on your own framework.

I have provided the ability to add references to courses. These are linked to specific levels within a skill, so that users can find courses to help them to attain that level.
...
All the skills and courses are designed to be consumed easily by machines. The site includes special features to enable machines to walk through and gather the information:
